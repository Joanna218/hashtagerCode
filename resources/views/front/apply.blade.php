...
<div id="apply">
  <div class="container">
    ...
    <form id="submit-form2" class="d-sm-block d-md-none" novalidate="">
      <!-- 申請人姓名、聯絡電話 -->
      <div class="form-group row">
        <label for="apply-name2">申請人姓名<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control apply-name2" name="apply-name2" required>
        <div class="invalid-feedback">
          請輸入申請人姓名
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="contact-tel2">聯絡電話<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control contact-tel2" name="contact-tel2" required>
        <div class="invalid-feedback">
          請輸入聯絡電話
        </div>
      </div>
      ...
      <!-- 公司全稱、公司聯絡電話 -->
      <div class="form-group row">
        <label for="corporation2">公司全稱<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control corporation2" name="corporation2" required>
        <div class="invalid-feedback">
          請輸入公司全稱
        </div>
      </div>
      <div class="form-group row">
        <label for="corporation-tel2">公司聯絡電話<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control corporation-tel2" name="corporation-tel2" required>
        <div class="invalid-feedback">
          請輸入公司聯絡電話
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="manage-item">公司經營項目<abbr class="text-danger">*</abbr></label>
          <select style="width:100%;" class="form-control mobile-manage-item-1" name="manage-item-1">
            <option value="農、林、漁、牧業">農、林、漁、牧業</option>
            <option value="礦業及土石採取業">礦業及土石採取業</option>
            <option value="製造業">製造業</option>
            <option value="水電燃氣業">水電燃氣業</option>
          ...
          <!-- 第二層選單 -->
          <select style="width:100%;margin-top:10px;display:none;" class="form-control mobile-manage-item-1-2" name="manage-item-1-2">
          </select>
          <!-- 第三層選單 -->
          <select style="width:100%;margin-top:10px;display:none;" class="form-control mobile-manage-item-1-2-3" name="manage-item-1-2-3">
          </select>
      </div>

      <!-- 品牌名稱、品牌種類 -->
      <div class="form-group row">
        <label for="brand-name2">品牌名稱<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control brand-name2" name="brand-name2" required>
        <div class="invalid-feedback">
          請輸入品牌名稱
        </div>
      </div>
      <div class="form-group row">
        <label for="brand-category2">品牌種類<abbr class="text-danger">*</abbr></label>
        <input type="text" class="form-control brand-category2" name="brand-category2" required>
        <div class="invalid-feedback">
          請輸入品牌種類
        </div>
      </div>
      ...
      <!-- 想要了解的活動類型 -->
      <div class="form-group row">
        <label class="more-activity-label" for="more-activity2">想要了解的活動類型<abbr class="text-danger">*</abbr></label>
        <select class="form-control more-activity2" name="more-activity2">
          <option value="轉發、打卡抽獎活動">轉發、打卡抽獎活動</option>
          <option value="內容創造分享">內容創造分享</option>
          <option value="產品試用、試吃體驗活動">產品試用、試吃體驗活動</option>
          <option value="線下體驗活動">線下體驗活動</option>
      ...
      <div class="form-group row">
        <label for="email2">E-mail<abbr class="text-danger">*</abbr></label>
        <input type="email" class="form-control email2" name="email2" placeholder="公司E-mail為佳" required>
        <div class="invalid-feedback">
          請輸入E-mail
        </div>
      </div>
      ...
      <div class="form-group row">
        <label>官方網址<abbr class="text-danger">*</abbr><small class="office-notic">若無請填寫無</small></label>
        <div class="office-item" style="width:100%;">
          <label for="offical-icon-home" class="offical-icon2">
            <i class="fas fa-home"></i></label>
          <input type="text" class="form-control offical-icon-home2" name="offical-icon-home2" placeholder="公司官方網站" required>
        </div>
      </div>
      <div class="form-group row">
        <div class="office-item" style="width:100%;">
          <label for="offical-icon-facebook" class="offical-icon2">
            <i class="fab fa-facebook"></i>
          </label>
          <input type="text" class="form-control offical-icon-facebook2" name="offical-icon-facebook2" placeholder="Facebook網站" required>
        </div>
      </div>

      <div class="form-group row">
        <div class="office-item" style="width:100%;">
          <label for="offical-icon-instagram" class="offical-icon2">
            <i class="fab fa-instagram"></i>
          </label>
          <input type="text" class="form-control offical-icon-instagram2" name="offical-icon-instagram2" placeholder="Instagram" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="other">
        <label for="other-required">其他</label>
          <textarea class="other-required2" rows="10"></textarea>
        </div>
      </div>
      <div class="form-group row justify-content-center mt-4">
        <button type="submit" class="btn submit-form submit-form1">送出</button>
...
<script>
  ...
  // 手機版
  // 第一層選單改變
  $('.mobile-manage-item-1').change(function() {
    // 隱藏與清除二三層的下拉選單
    clearAndNoneSelect('mobile-manage-item-1-2');
    clearAndNoneSelect('mobile-manage-item-1-2-3');
    // 顯示第二層與第三層
    triggerSelect('.mobile-manage-item-1-2', '.mobile-manage-item-1-2-3', $(this));
  });
  // 第二層選單改變
  $('.mobile-manage-item-1-2').change(function() {
    clearSelect('mobile-manage-item-1-2-3');
    // 顯示第三層
    triggerThridSelect('.mobile-manage-item-1-2-3', $(this));
  });
  ...
  $('#submit-form2').submit(function(e) {
    ...
    if (vForm[0].checkValidity() === false) {
      ...
      // 寄信
      var deskData = {
        'apply-name': $('.apply-name2').val(),
        'contact-tel': $('.contact-tel2').val(),
        'corporation': $('.corporation2').val(),
        'corporation-tel': $('.corporation-tel2').val(),
        'manage-Item': manageItem,
        'brand-name': $('.brand-name2').val(),
        'brand-category': $('.brand-category2').val(),
        'more-activity': $('.more-activity2').val(),
        'home': $('.offical-icon-home2').val(),
        'facebook': $('.offical-icon-facebook2').val(),
        'instagram': $('.offical-icon-instagram2').val(),
        'email': $('.email2').val(),
